...
export class GameService {
  ...
  // ! Exemplu de signal in loc de subject
  bestGame = signal<Game | null>(null);
  ...
  // }
  getGameDetails(id: number): Game | null {
    console.log(id);
    console.log(this.listOfGames.find((game) => game.id === id));
    return this.listOfGames.find((game) => game.id === id) ?? null;
  }
